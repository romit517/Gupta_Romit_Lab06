...
public class PizzaGUIFrame extends JFrame{
    ...
    private JCheckBox cheese, pepporoni, sausage, ham, bacon, mushrooms;
    ...
    private void orderTotalPrintout() {
        ...
        orderArea.append("Topping Total Amount: " + f.format(toppingTotal) + "\n");
        orderArea.append("Pizza Amount " + f.format(pizzaPrice) + "\n");
        orderArea.append("\n");
        orderArea.append("\n");
